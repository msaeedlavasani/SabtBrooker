...
- **CORS**: محدودیت‌های دامنه برای `sabt.saeedlavasani.ir` اصلاح شد.
- **مشکل شناخته شده (Known Issue)**: در حال حاضر فرآیند ارسال OTP با خطای «خطا در ارسال کد تایید» مواجه می‌شود. این موضوع در لایه اپلیکیشن در حال بررسی است و تا زمان رفع، ورود به پنل مسدود می‌باشد.
