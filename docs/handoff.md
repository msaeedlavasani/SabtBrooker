...
### ⚠️ نکات مهم پیکربندی
- **SMS Panel Password**: رمز عبور پنل ملی‌پیامک دقیقاً `B96$1` است. (تأکید: هیچ کاراکتر اضافی یا بک‌اسلشی ندارد).
- **Docker Env**: برای جلوگیری از ناهماهنگی، متغیرهای محیطی بک‌اِند مستقیماً از فایل `.env.production` بارگذاری می‌شوند.
